...
public class createtraining {
    ...
    static Boolean addTraining(WebDriver driverInst) throws InterruptedException {
        ...
        if (driverInst != null) {
            ...
            title.sendKeys("ctc test training 03");
            // fill location
...
//            List<WebElement> appts = waitMulti.until(ExpectedConditions.presenceOfAllElementsLocatedBy(By.xpath("//input[@id='__box10-CB']")));
//            if (appts != null) {
...
//            }
            ...
            save.click();
            sleep(40000);
//            WebDriverWait waitCreating = new WebDriverWait(driverInst, 40000);
